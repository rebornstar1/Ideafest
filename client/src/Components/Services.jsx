  ...
  return (
    <div className='pt-10 sm:mt-15 sm:pt-28 pb-10 sm:pb-20'>
      ...
      <div className='flex flex-row flex-wrap justify-around mx-auto sm:p-15' ref={myRef}>
            ...
            to ensure the utmost security and transparency for our investors.`} flag={flag} delay={0}/>
            ...
            and potential returns. Our platform provides comprehensive support, guiding entrepreneurs through the crowdfunding process from start to finish, including campaign setup, marketing strategies, and compliance with regulatory requirements.`} flag={flag} delay={0}/>
            ...
            due diligence on listed startups and providing ongoing monitoring and updates on investment progress.`} flag={flag} delay={0}/>  
      </div>
    </div>
  )
}
